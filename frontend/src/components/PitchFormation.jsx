...
function getPositions(formation) {
  const pitch = {
    GK:  { '4-3-3': [950,340], '4-4-2': [950,340], '3-5-2': [950,340], '5-4-1': [950,340], '4-2-3-1': [950,340] },
    LB:  { '4-3-3': [820,100], '4-4-2': [820,100], '3-5-2': [850,340], '5-4-1': [820,100], '4-2-3-1': [820,100] },
    CB:  { '4-3-3': [840,280], '4-4-2': [840,280], '3-5-2': [840,180], '5-4-1': [860,200], '4-2-3-1': [840,280] },
    RB:  { '4-3-3': [820,580], '4-4-2': [820,580], '3-5-2': [850,340], '5-4-1': [820,580], '4-2-3-1': [820,580] },
    LWB: { '5-4-1': [770,100] },
    RWB: { '5-4-1': [770,580] },
    CDM: { '4-2-3-1': [720,240] },
    CM:  { '4-3-3': [650,200], '4-4-2': [670,220], '3-5-2': [650,200], '5-4-1': [670,220], '4-2-3-1': [720,440] },
    CAM: { '4-2-3-1': [580,340] },
    LM:  { '4-4-2': [720,90],  '3-5-2': [720,90],  '5-4-1': [720,90] },
    RM:  { '4-4-2': [720,590], '3-5-2': [720,590], '5-4-1': [720,590] },
    LW:  { '4-3-3': [500,120], '4-2-3-1': [480,130] },
    RW:  { '4-3-3': [500,560], '4-2-3-1': [480,550] },
    ST:  { '4-3-3': [400,340], '4-4-2': [420,240], '3-5-2': [420,240], '5-4-1': [400,340], '4-2-3-1': [380,340] },
  };
